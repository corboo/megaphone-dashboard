...
export default function TopShows({ shows }: { shows: Show[] }) {
  ...
  return (
    <div className="bg-[#12121f] rounded-xl border border-[#1e1e35] p-5">
      <h2 className="text-lg font-semibold mb-1">Top Shows by Episode Count</h2>
      <p className="text-[#6b6b80] text-sm mb-4">
        {shows.length.toLocaleString()} shows
      </p>
